 ...
 * @str: str of the node
 * @num: node index as used by the history
...
/**
 * add_node_end - add node to the end of the given list
 * @head: address to the pointer to the  head node
 * @str: str field of the given node
 * @num: node index as used by the history
 * Return: size of the list
 */
 ...
 * @head_ptr: address to the pointer to the head node
 */
